                            ...
                            <v-row>
                                <v-col cols="6">
                                    ...
                                    <p class="text-caption" style="color: red">Deze applicatie is nog in ontwikkeling.
                                        ...
                                        applicatie hoor ik dat heel graag. Je kunt dat doen via email: lucas.jellema@conclusion.nl
                                        .
                                    </p>
                                    </p>
                                </v-col>
                            ...
                            <v-card-item>
                                <div>
                                    ...
                                    <div class="text-caption">
                                        {{ appStore.expertiseTags.length }} expertise tags and {{expertise.expertise.length}} technologies, products, roles and other areas of expertise. 
                                  
                                        <v-btn  text prepend-icon="mdi-map-search" to="/expertiseBrowse" class="mt-2" >Expertise in Ecosysteem</v-btn>
      <v-btn  text prepend-icon="mdi-account-group" to="/organization"  class="mt-2">Organization & Expertise</v-btn>
      <v-btn  text prepend-icon="mdi-brain" to="/expertise"  class="mt-2">Expertise Catalog</v-btn>
